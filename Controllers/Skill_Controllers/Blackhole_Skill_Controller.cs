...
public class Blackhole_Skill_Controller : MonoBehaviour
{
    ...
    public void SetupBlackhole(float _maxSize, float _growSpeed, float _shrinkSpeed, int _amountOfAttacks, float _cloneAttackCooldown, float _blackholeDuaration)
    {
        maxSize = _maxSize;
        ...
        blackholeTimer = _blackholeDuaration;
