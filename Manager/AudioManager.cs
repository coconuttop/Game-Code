...
public class AudioManager : MonoBehaviour
{
    ...
    public Coroutine areaCoroutine;
    ...
    public void StopSFXWithTime(int _index) => areaCoroutine = StartCoroutine(DecreaseVolume(sfx[_index]));
    ...
    public void PlayRandomBGM(int _bgmIndex)
    {
        bgmIndex = _bgmIndex;
