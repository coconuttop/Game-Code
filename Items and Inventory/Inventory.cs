...
public class Inventory : MonoBehaviour, ISaveManager
{
    ...
    public List<ItemData> staringItems;
    ...
    private void AddStaringItems()
    {
        ...
        {
            EquipItem(item as ItemData_Equipment);
        }
        ...
        for (int i = 0; i < staringItems.Count; i++)
        {
            if (staringItems[i] != null)
                AddItem(staringItems[i]);
        }
    }
    ...
    public void SavaData(ref GameData _data)
    {
